    ...
    def _decode(self, codes_str: str) -> np.ndarray:
        ...
        if not speech_ids:
            raise ValueError(
                ...
                "dẫn đến sai số khi tính toán. Bạn hãy thử chuyển sang dùng phiên bản VieNeu-TTS-0.3B "
                "nếu vẫn muốn dùng LmDeploy hoặc "
    ...
    def infer_batch(
        ...
        for i in range(0, len(texts), max_batch_size):
            ...
            prompts = [
                ...
                for text, ph in zip(batch_texts, batch_phonemes, strict=True)
            ]
