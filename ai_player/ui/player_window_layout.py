...
class PlayerLayoutMixin:
    def _build_ui(self) -> None:
        ...
        self._video_wider_button = self._make_button("video_wider", QIcon())
        self._video_wider_button.setToolTip(self._tr("video_wider_tooltip"))
        self._video_wider_button.setProperty("i18n_tooltip_key", "video_wider_tooltip")
        self._video_wider_button.clicked.connect(self._expand_video_panel)
        self._video_narrower_button = self._make_button("video_narrower", QIcon())
        self._video_narrower_button.setToolTip(self._tr("video_narrower_tooltip"))
        self._video_narrower_button.setProperty("i18n_tooltip_key", "video_narrower_tooltip")
        self._video_narrower_button.clicked.connect(self._shrink_video_panel)
        ...
        self._sidebar_wider_button = self._make_button("sidebar_wider", QIcon())
        self._sidebar_wider_button.setToolTip(self._tr("sidebar_wider_tooltip"))
        self._sidebar_wider_button.setProperty("i18n_tooltip_key", "sidebar_wider_tooltip")
        self._sidebar_wider_button.clicked.connect(self._expand_sidebar_panel)
        self._sidebar_narrower_button = self._make_button("sidebar_narrower", QIcon())
        self._sidebar_narrower_button.setToolTip(self._tr("sidebar_narrower_tooltip"))
        self._sidebar_narrower_button.setProperty("i18n_tooltip_key", "sidebar_narrower_tooltip")
        self._sidebar_narrower_button.clicked.connect(self._shrink_sidebar_panel)
        ...
        source_layout.addWidget(self._video_wider_button)
        source_layout.addWidget(self._video_narrower_button)
        source_layout.addWidget(self._video_fullscreen_button)
        source_layout.addWidget(self._sidebar_wider_button)
        source_layout.addWidget(self._sidebar_narrower_button)
        ...
        settings_grid.addWidget(self._auto_voice_gender_check, 12, 0, 1, 2)
        settings_grid.addWidget(self._field_label("male_voice"), 13, 0)
        settings_grid.addWidget(self._tts_male_voice_combo, 13, 1)
        settings_grid.addWidget(self._field_label("female_voice"), 14, 0)
        settings_grid.addWidget(self._tts_female_voice_combo, 14, 1)
        settings_grid.addWidget(self._auto_match_audio_check, 15, 0, 1, 2)
        ...
        settings_scroll.setObjectName("sideScroll")
